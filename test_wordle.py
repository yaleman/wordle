...
def test_regex_gen_complex(wordle):
    ...
    _, regex = wordle.generate_regex("genie", "bbgyg")
...
def test_regex_gen_complex2(wordle):
    ...
    _, regex = wordle.generate_regex("pinny", "bggbb")
